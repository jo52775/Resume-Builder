...
const Navbar: FC = () => {
  ...
  const handleLogout = async () => {
    ...
    fetch("https://resumai-api.onrender.com/logout", options)
  ...
  const displayProfile = async () => {
    try {
      const response = await fetch("https://resumai-api.onrender.com/user-profile", {
        credentials: "include",
      });
  ...
  const handleChangePassword = async (e: any) => {
    ...
    try {
      const response = await fetch("https://resumai-api.onrender.com/change-password", {
        credentials: "include",
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
