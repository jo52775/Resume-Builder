    ...
    return(
        <div className="details-form-container">
            ...
            <form>
                ...
                <div className="form-group">
                    <label htmlFor="work-experience">Enter relevant work experience: </label>
                        <input type="text" value={experience} onChange={(e) => setExperience(e.target.value)}/>
                </div>

                <div className="form-group">
                    <label htmlFor="projects">Enter projects with a brief description for each:  </label>
                        <input type="text" value={projects} onChange={(e) => setProjects(e.target.value)}/>
                </div>

                <div className="form-group">
                    <label htmlFor="skills">Enter your top skills:  </label>
                        <input type="text" value={skills} onChange={(e) => setSkills(e.target.value)} placeholder="e.g Javascript, Python, Microsoft Office, etc."/>
                </div>
